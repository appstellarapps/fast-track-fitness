  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        InkWell(
          onTap: (){
            controlManager.seekBackward(const Duration(seconds: 5));
          },
          child: SvgPicture.asset(ImageResourceSvg.backwardVideo),
        ),
        ...
        InkWell(
          onTap: (){
            controlManager.seekForward(const Duration(seconds: 5));
          },
          child: SvgPicture.asset(ImageResourceSvg.forwardVideo),
        ),
        const SizedBox(width: 30,),
