...
class MyStats extends StatelessWidget {
  ...
  exerciseStateView() {
    return Column(
      ...
      children: [
              ...
              SfCartesianChart(
                ...
                series: <ChartSeries<DistanceResult, String>>[
                  ColumnSeries<DistanceResult, String>(
                      ...
                      dataSource: controller.distanceModel.value.result!,
        ...
        ButtonRegular(
          onPress: () {
            Get.toNamed(Routes.ADD_STATS);
          },
          buttonText: "Add Today’s Stats",
        ),
  ...
  nutritionalStateView() {
    return controller.nutritionalStatsModel.result!.isUserTdee == 1
        ? Column(
            children: [
              const SizedBox(height: 20),
              commonDateSelectionView(),
                  ...
                  series: <ChartSeries<ChartDetail, String>>[
                    ColumnSeries<ChartDetail, String>(
                      ...
                      pointColorMapper: (ChartDetail data, _) {
                        return Color(
                            int.parse(data.totalColour.substring(1, 7), radix: 16) + 0xFF000000);
                      },
                    ),
                    ColumnSeries<ChartDetail, String>(
                      dataSource: controller.nutritionalStatsModel.result!.chartDetails,
  ...
  totalDurationView() {
    return SizedBox(
      ...
      child: ListView.separated(
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Color(int.parse(
                      controller.distanceModel.value.result![index].bodyColour.substring(1, 7),
                      radix: 16) +
                  0xFF000000),
            ),
            child: Column(
              ...
              children: [
                CachedNetworkImage(
                    imageUrl: controller.distanceModel.value.result![index].imageUrl,
                    fit: BoxFit.cover,
                    height: 30,
                    width: 30,
                    memCacheHeight: 100,
                ...
                Text(
                  controller.distanceModel.value.result![index].displayName,
                  style: CustomTextStyles.semiBold(
                    fontSize: 16.0,
                    fontColor: Color(int.parse(
                            controller.distanceModel.value.result![index].nameColour
                                .substring(1, 7),
                            radix: 16) +
                        0xFF000000),
                  ),
                ...
                const SizedBox(height: 5),
                Text(
                  "${controller.distanceModel.value.result![index].percentage}%",
        ...
        shrinkWrap: true,
        itemCount: controller.distanceModel.value.result!.length,
